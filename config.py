...
Data_Path = '/path/to/feature/data/grass_region=TW/grass_date={Day}'
Model_Save_Path = '/path/to/save/model/{Subcat}/{Day}/model'
Model_Summary_Path = '/path/to/save/model_summary/'
